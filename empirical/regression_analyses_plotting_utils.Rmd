...
data4plot= data.frame(fmse= c(colMeans(fmse_Van),colMeans(fmse_BIC)), sd_fmse= c(1.96*apply(fmse_Van, 2, stderror),1.96*apply(fmse_BIC, 2, stderror)),
                      algorithm= factor(x = rep(c('Vanilla', 'BIC'), each=79), levels = c('Vanilla', 'BIC')), freq=  seq(1,40,0.5))
...
data4plot= data.frame(MSE= c(rowMeans(exponent_Van), rowMeans(exponent_BIC)),
                      algorithm= factor(x = rep(c('Vanilla', 'BIC'), each=606), levels = c('Vanilla', 'BIC')) , age= factor(demo$Group, c('young adult', 'adult', 'older adult')), age_raw= demo$Age)
...
data4plot= data.frame(MSE= c(rowMeans(offset_Van), rowMeans(offset_BIC)),
                      algorithm= factor(x = rep(c('Vanilla', 'BIC'), each=606), levels = c('Vanilla','BIC')) , age= factor(demo$Group, c('young adult', 'adult', 'older adult')), age_raw= demo$Age)
