...
- `matplotlib <https://github.com/matplotlib/matplotlib>`_ for visualizing data and model fits
- `tqdm <https://github.com/tqdm/tqdm>`_ for printing progress bars when fitting many models
- `pandas <https://github.com/pandas-dev/pandas>`_ for exporting model fit results to dataframes
- `pytest <https://github.com/pytest-dev/pytest>`_ to run the test suite locally.
